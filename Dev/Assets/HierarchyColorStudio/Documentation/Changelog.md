...
- Color Studio window with Selection, Presets, Appearance and Assignments sections.
...
- Maintenance tools: select colored objects, remove missing entries, clear all colors, restore factory
  defaults, save now.
- Demo scene with a shipped color set, applied via
  **Tools → Hierarchy Color Studio → Samples → Apply Demo Colors**.
